...
In the case of the Hog descriptor, the miss rate dropped from 0.97 for 2000Kb/s to 0.81 for 500Kb/s. However, the fall is not as strong as for pedestrian detection, which is primarily related to the background in the video (the tone of the clothes of the people is dark and matches the tone of the walls and shadows).
